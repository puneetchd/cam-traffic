...
class TrafficDataModelTest: XCTestCase {
    ...
    override func setUp() {
        trafficData = DataTraffic(rootItem: [
            DataTraffic.ItemsList(camerasList: [
                DataTraffic.ItemsList.DataTrafficCamera(
                    imageURL: URL(string: "https://images.data.gov.sg/api/traffic-images/2020/01/d50a5c10-6461-4874-bb8f-0df978083379.jpg"),
                    locationCoordinate: ["latitude": 1.28569398886979, "longitude": 103.837524510188])
            ])
        ])
    }
